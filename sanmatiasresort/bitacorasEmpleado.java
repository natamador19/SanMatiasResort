 ...
 * @author Juanfer Siu
 */
public class bitacorasEmpleado extends javax.swing.JFrame {
   ...
   Utilidades util = new Utilidades();
    ...
    rs=conn.LlenarTabla("SELECT * from bitacora_empleados");
    model.setColumnIdentifiers(new Object[] {"#","Cambio","Fecha de Cambio","Codigo Empleado","DNI Empleado","Fecha Nacimiento","Direccion","Email","Telefono","Fecha contratación","Codigo Puesto","Estado"});
       try { 
           while(rs.next()){
           model.addRow(new Object[]{rs.getString("codigo"),rs.getString("cambio"),rs.getString("fecha_cambio"),rs.getString("codigo_empleado"),rs.getString("dni_empleado"),rs.getString("fecha_nacimiento_empleado"),rs.getString("direcccion_empleado"),rs.getString("email_empleado"), rs.getString("tel_empleado"),rs.getString("fecha_contratacion_empleado"),rs.getString("codigo_puesto"),rs.getString("estado_empleado")});

           }  
           tablabitacoras.setModel(model);
       } catch (SQLException ex) {
           Logger.getLogger(bitacorasEmpleado.class.getName()).log(Level.SEVERE, null, ex);
       }
    ...
    private void initComponents() {
        ...
        lblbitacoras.setText("BITACORA EMPLEADO");
        ...
        panelprincipalLayout.setHorizontalGroup(
            ...
            .addGroup(panelprincipalLayout.createSequentialGroup()
                ...
                .addGroup(panelprincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jScrollPane1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 1162, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnvolverbitacoras, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 193, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
...
public void Filter(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bitacorasEmpleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new bitacorasEmpleado().setVisible(true);
            }
        });
    }
