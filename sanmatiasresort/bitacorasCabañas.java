 ...
 * @author Juanfer Siu
 */
public class bitacorasCabañas extends javax.swing.JFrame {
   ...
   Utilidades util = new Utilidades();
    ...
    DefaultTableModel model=new DefaultTableModel();
        ...
        rs=conn.LlenarTabla("select * from bitacora_cabaña");
        try {
           while(rs.next()){
           model.addRow(new Object[]{rs.getString("codigo"),rs.getString("cod_cabaña"),rs.getString("Fecha_cambio"),rs.getString("descripcion_cabaña"),rs.getString("capacidad_cabaña"),rs.getString("precio"),rs.getString("estado")});

           }  
           tablabitacoras.setModel(model);
       } catch (SQLException ex) {
           Logger.getLogger(bitacorasCabañas.class.getName()).log(Level.SEVERE, null, ex);
       }
    ...
    private void initComponents() {
        ...
        lblbitacoras.setText("BITACORA CABAÑA");
        ...
        panelprincipalLayout.setHorizontalGroup(
            ...
            .addGroup(panelprincipalLayout.createSequentialGroup()
                .addGroup(panelprincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(panelprincipalLayout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(btnvolverbitacoras, javax.swing.GroupLayout.PREFERRED_SIZE, 153, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        panelprincipalLayout.setVerticalGroup(
            ...
            .addGroup(panelprincipalLayout.createSequentialGroup()
                ...
                .addGroup(panelprincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(panelprincipalLayout.createSequentialGroup()
                        .addComponent(lblbitacoras, javax.swing.GroupLayout.DEFAULT_SIZE, 84, Short.MAX_VALUE)
                        .addGap(18, 18, 18)
                        .addComponent(lblfiltrar, javax.swing.GroupLayout.DEFAULT_SIZE, 68, Short.MAX_VALUE)
...
public void Filter(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bitacorasCabañas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new bitacorasCabañas().setVisible(true);
            }
        });
    }
