 ...
 * @author Juanfer Siu
 */
public class bitacorasReservacion extends javax.swing.JFrame {
   PreparedStatement ps; 
   Conexion conn= new Conexion();
   Connection con=conn.conectar();
   ResultSet rs;
   DefaultTableModel dtm; 
     String qry="SELECT * FROM sanmatiasresort.bitacora_reservaciones;";
   private TableRowSorter trsFiltro;
   Utilidades util = new Utilidades();
   
    public bitacorasReservacion() {
        initComponents();
        MostrarTabla();
    ...
    rs=conn.LlenarTabla("SELECT * FROM sanmatiasresort.bitacora_reservaciones;");
    model.setColumnIdentifiers(new Object[] {"#","Cambio","Fecha de Cambio","Código Reservacion","Dni Cliente","Código cabaña","Fecha Llegada","Fecha Salida"});
       try {
           while(rs.next()){
           model.addRow(new Object[]{rs.getString("codigo"),rs.getString("cambio"),rs.getString("fecha_cambio"),rs.getString("codigo_reservacion"),rs.getString("dni_cliente"),rs.getString("codigo_cabaña"),rs.getString("fecha_llegada"),rs.getString("fecha_salida")});

           }  
           tablabitacoras.setModel(model);
       } catch (SQLException ex) {
           Logger.getLogger(bitacorasReservacion.class.getName()).log(Level.SEVERE, null, ex);
       }
    ...
    private void initComponents() {
        ...
        lblbitacoras.setText("BITACORA RESERVACIÓN");
...
public void Filter(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bitacorasReservacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new bitacorasReservacion().setVisible(true);
            }
        });
    }
