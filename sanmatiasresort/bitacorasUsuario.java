 ...
 * @author Juanfer Siu
 */
public class bitacorasUsuario extends javax.swing.JFrame {
   ...
   Utilidades util = new Utilidades();
    ...
    rs=conn.LlenarTabla("SELECT * FROM sanmatiasresort.bitacora_usuario;");
    model.setColumnIdentifiers(new Object[] {"#","cambio","fecha_cambio","usuario","fecha creación","contraseña usuario","codigo empleado","codigo_rol","estado"});
       try {
           while(rs.next()){
           model.addRow(new Object[]{rs.getString("codigo"),rs.getString("cambio"),rs.getString("fecha_cambio"),rs.getString("nombre_usuario"),rs.getString("fecha_creacion"),rs.getString("contraseña_usuario"),rs.getString("codigo_empleado"),rs.getString("codigo_rol"),rs.getString("estado_usuario")});

           }  
           tablabitacoras.setModel(model);
       } catch (SQLException ex) {
           Logger.getLogger(bitacorasUsuario.class.getName()).log(Level.SEVERE, null, ex);
       }
    ...
    private void initComponents() {
        ...
        lblbitacoras.setText("BITACORA USUARIO");
...
public void Filter(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bitacorasUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new bitacorasUsuario().setVisible(true);
            }
        });
    }
